      ...
      <div className="max-w-7xl mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 flex flex-col items-center text-center">
            ...
            <a href="https://givealittle.co.nz/cause/help-us-be-there-for-carers-today-not-tomorrow" target="_blank" rel="noopener noreferrer" className="w-full bg-brand-dark text-white py-3 rounded-full font-bold hover:bg-[#202d15] transition shadow-md block">
              MAKE A DONATION
            </a>
          </div>
        </div>
